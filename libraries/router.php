<?php
    ...
    /*if($deviceType == 'mobile') define('TEMPLATE','./m/');
	...
	$_SESSION['lang'] = 'vi';//Ẩn khi có 2 ngôn ngữ
	$lang = $_SESSION['lang'];
	...
	/* Tối ưu link */
	$requick = array(
		array("tbl"=>"news_list","field"=>"idl","source"=>"news","com"=>"chieu-sinh-dao-tao","type"=>"chieu-sinh-dao-tao",'menu'=>true),
		array("tbl"=>"news","field"=>"id","source"=>"news","com"=>"chieu-sinh-dao-tao","type"=>"chieu-sinh-dao-tao",'menu'=>true),
	...
	switch($com)
	{
		case 'tra-cuu-thong-tin':
			$source = "tracuu";
			$template = "tracuu/tracuu";
			$type = 'tra-cuu';
			$seo->setSeo('type','article');
			$title_crumb = 'Tra cứu';
			break;

		case 'tra-cuu-qr-thanh-toan':
			$source = "tracuu";
			$template = "tracuu/qr";
			$type = 'tra-cuu';
			$seo->setSeo('type','article');
			$title_crumb = 'QR Thanh toán';
			break;
		...
		case 'lien-he':
			...
			$title_crumb = 'Đăng ký tận nơi - thủ tục đơn giản';
			break;
		...
		case 'tin-tuc':
			...
			$type = $com;
			$title_crumb = 'Thông tin mới nhất';
			break;
		...
		case 'dao-tao':
			...
			$seo->setSeo('type',isset($_GET['id']) ? "article" : "object");
			$type = $com;
			$title_crumb = 'Hạng Đào tạo';
			break;

		case 'chieu-sinh-dao-tao':
			$source = "news";
			$template = isset($_GET['id']) ? "news/news_detail" : "news/news";
			$seo->setSeo('type',isset($_GET['id']) ? "article" : "object");
			$type = $com;
			$title_crumb = 'Chiêu sinh - Đào tạo';
			break;
	...
	$hieuung =array("wow fadeInLeft","wow fadeInRight","wow fadeInUp","wow bounce","wow flash","wow pulse","wow rubberBand","wow shake","wow swing","wow tada","wow wobble","wow jello","wow bounceIn","wow bounceInDown","wow bounceInLeft","wow bounceInRight","wow bounceInUp","wow bounceOut","wow bounceOutDown","wow bounceOutLeft","wow bounceOutRight","wow bounceOutUp","wow fadeIn","wow fadeInDown","wow fadeInDownBig","wow fadeInLeftBig","wow fadeInRight","wow fadeInRightBig","wow fadeInUp","wow fadeInUpBig","wow fadeOut","wow fadeOutDown","wow fadeOutDownBig","wow fadeOutLeft","wow fadeOutLeftBig","wow fadeOutRight","wow fadeOutRightBig","wow fadeOutUp","wow fadeOutUpBig","wow flip","wow flipInX","wow flipInY","wow flipOutX","wow flipOutY");
?>