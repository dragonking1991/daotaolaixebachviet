<?php
    ...
    $config['static'][$nametype]['thongtinthem'] = false;
    $config['static'][$nametype]['so1'] = false;
    $config['static'][$nametype]['so2'] = false;
    $config['static'][$nametype]['so3'] = false;
    $config['static'][$nametype]['so4'] = false;
    $config['static'][$nametype]['so5'] = false;
    ...
    /* Liên hệ */
    $nametype = "lien-he";
    $config['static'][$nametype]['title_main'] = "Đăng ký tận nơi";
    $config['static'][$nametype]['noidung'] = true;
    $config['static'][$nametype]['noidung_cke'] = true;
    $config['static'][$nametype]['images'] = true;
    $config['static'][$nametype]['seo'] = true;
    ...
    $nametype = "tra-cuu";
    $config['static'][$nametype]['title_main'] = "Tra cứu thông tin";
    $config['static'][$nametype]['noidung'] = true;
    $config['static'][$nametype]['noidung_cke'] = true;
    $config['static'][$nametype]['images'] = true;
    $config['static'][$nametype]['seo'] = true;
