...
<section class="content">
	                    ...
	                    <tbody>
	                        <?php for($i=0;$i<count($items);$i++) { ?>
	                            <tr>
	                                ...
	                                <td class="align-middle">
                                    	<a href="<?=$linkEditImg?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['photo']?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.png'" src="<?=THUMBS?>/<?=$config['import']['thumb']?>/<?=UPLOAD_EXCEL_L.$items[$i]['photo']?>" alt="<?=$items[$i]['photo']?>"></a>
                                    </td>
	                                <td class="align-middle">
    ...
    <p style="font-size: 16px;font-weight: bold;color: red;padding-top: 10px;padding-left: 10px;">Mẫu số cột và thứ tự các cột trong file Excel</p>
    <img src="assets/images/<?=$_GET['type']?>.png" alt="">
