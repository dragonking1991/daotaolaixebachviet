...
<section class="content-header text-sm">
	<div class="container-fluid">
		<ol class="breadcrumb float-sm-left">
			...
			<li class="breadcrumb-item"><a href="index.php?com=daotao&act=dat">DAT</a></li>
			<li class="breadcrumb-item active">Import</li>
		</ol>
	</div>
</section>
<section class="content">
	<form method="post" action="index.php?com=daotao&act=uploadDatExcel" enctype="multipart/form-data">
		<div class="card card-primary card-outline text-sm">
			<div class="card-header"><h3 class="card-title"><strong>Import file DAT của Cục</strong></h3></div>
			<div class="card-body">
			...
			<div class="card-footer">
				...
				<a href="index.php?com=daotao&act=dat" class="btn btn-sm bg-gradient-secondary text-white">Quay lại</a>
			</div>
		</div>
	</form>
</section>
