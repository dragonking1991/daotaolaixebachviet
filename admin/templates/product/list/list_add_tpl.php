<?php
    ...
    if(
        (isset($config['product'][$type]['images_list']) && $config['product'][$type]['images_list'] == true) ||
        (isset($config['product'][$type]['icon_list']) && $config['product'][$type]['icon_list'] == true)
    )
    {
        $colLeft = "col-xl-8";
        $colRight = "col-xl-4";
            ...
            <div class="<?=$colRight?>">
                <?php if(isset($config['product'][$type]['icon_list']) && $config['product'][$type]['icon_list'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            <?php
                                $photoDetailicon = UPLOAD_PRODUCT.@$item['icon'];
                                $dimensionicon = "Width: ".$config['product'][$type]['width_list_icon']." px - Height: ".$config['product'][$type]['height_list_icon']." px (".$config['product'][$type]['img_type_list'].")";
