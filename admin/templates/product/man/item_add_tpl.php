		                            ...
		                            <?php foreach($config['website']['lang'] as $k => $v) { ?>
		                                <div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <input type="text" class="form-control for-seo" name="data[ngaysinh]" id="ngaysinh" placeholder="Ngày sinh" value="<?=@$item['ngaysinh']?>">
		                                    </div>
		                                    ...
		                                    <?php if($_GET['type']=='gplx') { ?>
			                                    <div class="form-group">
			                                        ...
			                                        <input type="text" class="form-control for-seo" name="data[gplx]" id="gplx" placeholder="Số GPLX" value="<?=@$item['gplx']?>">
			                                    </div>
		                                	<?php } ?>
		                                	...
		                                	<?php if(isset($config['product'][$type]['gia']) && $config['product'][$type]['gia'] == true) { ?>
										    	<div class="form-group col-md-12">
							                        <label class="d-block" for="gia">Số tiền:</label>
							                        <div class="input-group">
							                        	<input type="text" class="form-control format-price gia_ban" name="data[gia]" id="gia" placeholder="Giá" value="<?=@$item['gia']?>">
	    ...
	    <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="row">
				    ...
				    <?php if(isset($config['product'][$type]['diachi']) && $config['news'][$type]['diachi'] == true) { ?>
	                    <div class="form-group col-md-4 col-sm-6">
	                        <label for="diachi">Địa chỉ:</label>
	                        <input type="text" class="form-control" name="data[options2][diachi]" id="diachi" placeholder="Địa chỉ" value="<?=$options2['diachi']?>">
	                    </div>
	                <?php } ?>

	                <?php if(isset($config['product'][$type]['sotang']) && $config['news'][$type]['sotang'] == true) { ?>
	                    <div class="form-group col-md-4 col-sm-6">
	                        <label for="sotang">Số tầng:</label>
	                        <input type="text" class="form-control" name="data[options2][sotang]" id="sotang" placeholder="Số tầng" value="<?=$options2['sotang']?>">
	                    </div>
	                <?php } ?>

	                <?php if(isset($config['product'][$type]['phongngu']) && $config['news'][$type]['phongngu'] == true) { ?>
	                    <div class="form-group col-md-4 col-sm-6">
	                        <label for="phongngu">Số phòng ngủ:</label>
	                        <input type="text" class="form-control" name="data[options2][phongngu]" id="phongngu" placeholder="Số phòng ngủ" value="<?=$options2['phongngu']?>">
	                    </div>
	                <?php } ?>

	                <?php if(isset($config['product'][$type]['tolet']) && $config['news'][$type]['tolet'] == true) { ?>
	                    <div class="form-group col-md-4 col-sm-6">
	                        <label for="tolet">Số tolet:</label>
	                        <input type="text" class="form-control" name="data[options2][tolet]" id="tolet" placeholder="Số tolet" value="<?=$options2['tolet']?>">
	                    </div>
	                <?php } ?>
