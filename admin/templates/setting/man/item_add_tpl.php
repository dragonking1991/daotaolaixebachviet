				...
				<div class="row">
					...
					<?php if(isset($config['setting']['slogan']) && $config['setting']['slogan'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							...
							<input type="text" class="form-control" name="data[options][slogan]" id="slogan" placeholder="Slogan top" value="<?=$options['slogan']?>">
						</div>
					<?php } ?>
					...
					<?php } ?>
					<?php if(isset($config['setting']['chiduong']) && $config['setting']['chiduong'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
					...
					<?php } ?>
					<?php if(isset($config['setting']['giohoatdong']) && $config['setting']['giohoatdong'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
					...
					<?php if(isset($config['setting']['soluong_sp']) && $config['setting']['soluong_sp'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
					...
					<?php } ?>
					<?php if(isset($config['setting']['soluong_spk']) && $config['setting']['soluong_spk'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
					...
					<?php } ?>
					<?php if(isset($config['setting']['soluong_tin']) && $config['setting']['soluong_tin'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
					...
					<?php } ?>
					<?php if(isset($config['setting']['soluong_tink']) && $config['setting']['soluong_tink'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
				...
				<?php if(isset($config['setting']['toado_iframe']) && $config['setting']['toado_iframe'] == true) { ?>
					<div class="form-group">
						<label for="toado_iframe">
							<span>Tọa độ google map iframe 1:</span>
					...
					<div class="form-group">
						<label for="toado_iframe">
							<span>Tọa độ google map iframe 2:</span>
						</label>
						<textarea class="form-control" name="data[options][toado_iframe2]" id="toado_iframe2" rows="5" placeholder="Tọa độ google map iframe"><?=htmlspecialchars_decode($options['toado_iframe2'])?></textarea>
					</div>
				<?php } ?>
				<div class="form-group">
