    ...
    <form method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="form-group-category row">
                    ...
                    <?php if(isset($config['newsletter'][$type]['chude']) && $config['newsletter'][$type]['chude'] == true) { ?>
                        <div class="form-group col-md-4">
                            ...
                            <input type="chude" class="form-control" name="data[chude]" id="chude" placeholder="Chủ đề" value="<?=@$item['chude']?>">
                        </div>
                    <?php } ?>
                ...
                <?php if(isset($config['newsletter'][$type]['body']) && $config['newsletter'][$type]['body'] == true) { ?>
                    <div class="form-group">
                        <label for="body">Thông tin:</label>
                        <textarea class="form-control form-control-ckeditor" name="data[body]" id="body" rows="5" placeholder="Ghi chú"><?=@$item['body']?></textarea>
                    </div>
                <?php } ?>
