            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <?php } ?>
                        <?php if(isset($config['newsletter'][$type]['showemail']) && $config['newsletter'][$type]['showemail'] == true) { ?>
                            <th class="align-middle">Email</th>
                        <?php } ?>
                        <?php if(isset($config['newsletter'][$type]['showdiachi']) && $config['newsletter'][$type]['showdiachi'] == true) { ?>
                            <th class="align-middle">Địa chỉ</th>
                        <?php } ?>
                        <?php if(isset($config['newsletter'][$type]['showchude']) && $config['newsletter'][$type]['showchude'] == true) { ?>
                            <th class="align-middle">Chủ đề</th>
                        <?php } ?>
                        <?php if(isset($config['newsletter'][$type]['shownoidung']) && $config['newsletter'][$type]['shownoidung'] == true) { ?>
                    ...
                    <tbody>
                        <?php for($i=0;$i<count($items);$i++) { ?>
                            <tr>
                                ...
                                <?php } ?>
                                <?php if(isset($config['newsletter'][$type]['showdiachi']) && $config['newsletter'][$type]['showdiachi'] == true) { ?>
                                    <td class="align-middle"><?=$items[$i]['diachi']?></td>
                                <?php } ?>
                                <?php if(isset($config['newsletter'][$type]['showchude']) && $config['newsletter'][$type]['showchude'] == true) { ?>
                                    <td class="align-middle"><?=$items[$i]['chude']?></td>
                                <?php } ?>

                                <?php if(isset($config['newsletter'][$type]['shownoidung']) && $config['newsletter'][$type]['shownoidung'] == true) { ?>
                                    <td class="align-middle"><?=$items[$i]['noidung']?></td>
                                <?php } ?>
