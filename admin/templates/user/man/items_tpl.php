<?php
    ...
    $canAddUser = $isRootUser || (isset($_SESSION['list_quyen']) && in_array('user_add', $_SESSION['list_quyen']));
    $canEditUser = $isRootUser || (isset($_SESSION['list_quyen']) && in_array('user_edit', $_SESSION['list_quyen']));
    $canDeleteUser = $isRootUser || (isset($_SESSION['list_quyen']) && in_array('user_delete', $_SESSION['list_quyen']));
?>
                        ...
                        <?php for($i=0;$i<count($items);$i++) { ?>
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                	<div class="custom-control custom-checkbox my-checkbox">
                                        <input type="checkbox" class="custom-control-input show-checkbox" id="show-checkbox-<?=$items[$i]['id']?>" data-table="member" data-id="<?=$items[$i]['id']?>" data-loai="hienthi" <?=($items[$i]['hienthi'])?'checked':''?> <?=($canEditUser)?'':'disabled'?>>
