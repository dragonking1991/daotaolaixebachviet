<?php
	...
	$linkEdit = "index.php?com=contact&act=edit&type=".$type."&p=".$curPage;
	$linkDelete = "index.php?com=contact&act=delete&type=".$type."&p=".$curPage;
?>
                        ...
                        <?php for($i=0;$i<count($items);$i++) { ?>
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                	<div class="custom-control custom-checkbox my-checkbox">
                                        <input type="checkbox" class="custom-control-input show-checkbox" id="show-checkbox-<?=$items[$i]['id']?>" data-table="contact" data-id="<?=$items[$i]['id']?>" data-loai="hienthi" <?=($items[$i]['hienthi'])?'checked':''?>>
